...
import com.example.randomuser.presentation.navigator.KEY_AGR_SCREEN
...
class ViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        val navigator = navigatorProvider[MainActivityNavigator::class.java]
...
inline fun <reified VM : ViewModel> BaseFragment.screenViewModel() = viewModels<VM> {
    val screen = requireArguments().getSerializable(KEY_AGR_SCREEN) as BaseScreen
